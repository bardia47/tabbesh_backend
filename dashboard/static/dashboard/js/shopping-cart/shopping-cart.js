    ...
    $.each(installmentCards, function (index, course) {
        ...
        <div class="row card-row">
            ...
            <div class="card-body">
              <div class="row">
                <!-- Course image -->
                <div class="col-md-2 cart-course-image">
                  <img src="" alt="course image">
                </div>
                <!-- Course title -->
                <div class="col-md-3 cart-course-title">
                  <p class="cart-course-title">مشاوره نهم</p>
                </div>
                <!--Course teacher name -->
                <div class="col-md-3 cart-course-teacher-name">
                  <p>استاد یوسف بهلولی</p>
                </div>
                <!-- Button-to-delete -->
          ...
          <input type="hidden" class="cart-course-id" value="${course.id}">
          </div>
        </div>`;
