...
from .enums.enum_role_code import RoleCodeEnum
...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, phone_number, password, **extra_fields):
        ...
        try:
            ...
            if is_superuser:
                user.role = role.objects.get(code=RoleCodeEnum.ADMIN.value)
            else:
                user.role = role.objects.get(code=RoleCodeEnum.STUDENT.value)
